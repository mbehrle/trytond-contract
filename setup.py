...
name = 'm9s_contract'
download_url = 'https://gitlab.com/m9s/contract.git'
requires = []
...
tests_require = [
    ...
    get_require_version('trytond-analytic-invoice'),
    ]
dependency_links = []
if minor_version % 2:
...
setup(name=name,
    version=version,
    description='Tryton Contract Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/contract.git',
        },
    keywords='',
    package_dir={'trytond.modules.contract': '.'},
    packages=(
        ['trytond.modules.contract']
        + ['trytond.modules.contract.%s' % p
